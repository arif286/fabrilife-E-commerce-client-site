import { Card, CircularProgress, Container, Grid, makeStyles } from '@material-ui/core';
...
const CheckOut = () => {
  const classes = useStyles();
    ...
    useEffect(() => {
        axios
          .get(`https://lychee-custard-24286.herokuapp.com/product/${id}`)
  ...
  const [placeOrder, setPlaceOrder] = useState(false);
   const onSubmit = (data) => {
     ...
     axios
       .post("https://lychee-custard-24286.herokuapp.com/order", customerInfo)
