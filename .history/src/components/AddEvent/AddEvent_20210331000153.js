        ...
        <Grid container spacing={4}>
          <Grid item xs={12} sm={6}>
            <div className="event-input">
              ...
              <input name="service" placeholder="title" ref={register} />
          ...
          <Grid item xs={12} sm={6}>
            <div className="event-input">
              ...
              <input name="bedroom" placeholder="number" ref={register} />
              <label htmlFor="bathroom">No of Bathroom</label>
              <input name="bathroom" placeholder="number" ref={register} />
